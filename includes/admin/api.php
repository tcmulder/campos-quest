...
add_action( 'rest_api_init', function () {
    register_rest_route( 'campos-quest/v1', '/winner/', array(
        'methods' => 'POST',
        'callback' => function ( $request ) {
            ...
            if (!$is_debug) {
                ...
                $leaderboard = array_slice( $leaderboard, 0, CAMPOS_QUEST_LEADERBOARD_COUNT );
 ...
 */
add_action( 'rest_api_init', function () {
    register_rest_route( 'campos-quest/v1', '/leaderboard/', array(
        'methods' => 'GET',
        'callback' => function ( $request ) {
            $leaderboard = get_option( 'campos_quest_settings_leaderboard', array() );
